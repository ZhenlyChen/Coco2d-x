...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	for (int i = 0; i < faceFrames; i++)
	{
		sprintf(faceframe, "miner-face-whistle-%d.png", i);
		faceAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(faceframe));
	}
	...
	char diamondFrames = 6;
	char diamondFramesName[30];
	Animation* diamondAnimation = Animation::create();

	for (int i = 0; i < diamondFrames; i++) {
		sprintf(diamondFramesName, "diamond-%d.png", i);
